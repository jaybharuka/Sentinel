...
//
// On Vercel: each serverless function instance has its own independent
// `buckets` map, so under concurrent traffic across multiple instances the
// effective limit is roughly (nominal limit x concurrent instance count),
// not a hard global ceiling - same single-process caveat as
// lib/merchantLock.js. A real deployment would move this to Redis or
